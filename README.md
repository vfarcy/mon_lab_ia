...
* **Processeur (CPU) :** Minimum 4 cœurs / 8 threads (ici un **Intel i7-3770** clairement limitant pour le GPU). Assure le chargement initial des modèles.
...
3.  **Au boot éventuellement  :**
    ...
    Ou alors, corriger définitivement en automatisant le lancement du serveur web au boot  :
